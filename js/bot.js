...
countDown(countDown){
  ...
  let hours = Math.floor((countDownDisplay % (1000 * 60 * 60 * 24)) / (1000 * 60 * 60));
  let minutes = Math.floor((countDownDisplay % (1000 * 60 * 60)) / (1000 * 60));
  let seconds = Math.floor((countDownDisplay % (1000 * 60)) / 1000);
